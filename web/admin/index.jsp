...
<div class="header bg-main">
  ...
  <div class="head-l">
    ...
    <a href="LogoutServlet" style="margin-left:30px;"><img style="vertical-align: middle;" src="../web/img/logout.png">登出</a>
  </div>
</div>
<div class="leftnav">
  ...
  <ul>
    <li><a href="FondStuServlet?type=stu" target="right"><span class="icon-caret-right"></span>学生Edit</a></li>
  </ul>
  <h2><span class="icon-pencil-square-o"></span>教师管理</h2>
  <ul>
    <li><a href="FondStuServlet?type=tea" target="right"><span class="icon-caret-right"></span>教师Edit</a></li>
  </ul>
  <h2><span class="icon-pencil-square-o"></span>班级管理</h2>
  <ul>
    <li><a href="../web/main.html" target="right"><span class="icon-caret-right"></span>班级Edit</a></li>
  </ul>
</div>
