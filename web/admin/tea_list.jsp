...
<table class="gridtable">
    ...
    <c:forEach items="${stu}" var="a">
        <form action="StuInfoServlet?no=${a.No}&type=teacher" method="post">
            <tr>
                <td>${a.id}</td>
                ...
                <td><input type="submit" value="编辑"><a href="DelUserServlet?no=${a.No}&type=tea" style="margin-left: 5px;"><input type="button" value="删除"></a></td>
            </tr>
        </form>
    </c:forEach>
</table>
