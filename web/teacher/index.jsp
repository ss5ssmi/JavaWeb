...
<div class="leftnav">
  ...
  <ul>
    <li><a href="FondSourceServlet" target="right"><span class="icon-caret-right"></span>成绩Edit</a></li>
    <li><a href="FondStuServlet" target="right"><span class="icon-caret-right"></span>学生查询</a></li>
    <li><a href="../web/main.html" target="right"><span class="icon-caret-right"></span>班级查询</a></li>
  </ul>
</div>
